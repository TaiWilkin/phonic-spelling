const words = {
  ...
  heat: { letters: ["h", "ea", "t"] },
  heal: { letters: ["h", "ea", "l"] },
  year: { letters: ["hard-y", "ea", "r"] },
  speak: { letters: ["s", "p", "ea", "k"] },
  road: { letters: ["r", "oa", "d"] },
  coat: { letters: ["hard-c", "oa", "t"] },
  goat: { letters: ["g", "oa", "t"] },
  toad: { letters: ["t", "oa", "d"] },
  throat: { letters: ["unvoiced-th", "r", "oa", "t"] },
  tie: { letters: ["t", "ie"], sentence: "She wore a tie to the dance." },
  die: { letters: ["d", "ie"], sentence: "He rolled the die." },
  lead: { letters: ["l", "ea", "d"], sentence: "I'll lead, and you follow." },
  lean: { letters: ["l", "ea", "n"] },
